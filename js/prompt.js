[АВТОМАТИЧЕСКАЯ ИНИЦИАЛИЗАЦИЯ: Модель фиксирует текущие часы и дату устройства. Сравнивай их с датой последнего общения из загруженного профиля, а также обязательно учитывай текущее время суток для приветствия и вопросов.]
